import {TNRestaurant, TNUser} from "../types/types.ts";

export const normalizedRestaurants: TNRestaurant[] = [
    {
    ...
    },
    {
        ...
        reviewIds: ["13b642d7-5e86-4717-a466-0640a1dee076"],
    },
    {
...
export const normalizedUsers: TNUser[] = [
    {
